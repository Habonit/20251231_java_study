...
| 01 | 1. 클래스와 데이터.pdf |
| 02 | 2. 기본형과 참조형.pdf |
| 03 | 3. 객체 지향 프로그래밍.pdf |
| 04 | 4. 생성자.pdf |
| 05 | 5. 패키지.pdf |
| 06 | 6. 접근 제어자.pdf |
| 07 | 7. 자바 메모리 구조와 static.pdf |
| 08 | 8. final.pdf |
| 09 | 9. 상속.pdf |
| 10 | 10. 다형성1.pdf |
| 11 | 11. 다형성2.pdf |
...
PDF 파일명 앞의 숫자를 두 자리로 맞춰 폴더명으로 사용한다:

| PDF 파일 | 챕터 폴더 |
|:-----|:-----|
| 1. 클래스와 데이터.pdf | chapter_01/ |
| 2. 기본형과 참조형.pdf | chapter_02/ |
| 10. 다형성1.pdf | chapter_10/ |
...
2. `material/chapters/chapter_{번호}/` 디렉토리 구조를 생성한다
